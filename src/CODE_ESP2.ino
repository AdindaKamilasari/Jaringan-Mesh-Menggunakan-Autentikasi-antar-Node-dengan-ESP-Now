...
const char* mqttClientID = "esp32-client2";
const char* mqttTopic = "XXXXXX";

// MAC addresses of ESP1 and ESP3
...
String esp2Message = "Halo 2"; // Message from ESP2
...
void sendMQTTMessage() {
  String mqttMessage = "ESP2 = " + esp1Message + ", " + esp2Message + ", " + esp3Message;
...
void loop() {
  // Prepare message for ESP1 and ESP3
  strcpy(outgoingMessage.text, esp2Message.c_str());
